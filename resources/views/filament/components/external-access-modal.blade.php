<div class="space-y-4">
    <div>
        <h4 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">{{ __('app.dashboard_url') }}</h4>
    ...
    <div>
        <h4 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">{{ __('app.password') }}</h4>
        <div class="flex items-center space-x-2">
            <input 
                type="text" 
    ...
    @if($lastAccessed)
    <div>
        <h4 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">{{ __('app.last_accessed') }}</h4>
        <p class="text-sm text-gray-600 dark:text-gray-400">{{ $lastAccessed }}</p>
    </div>
    @endif

    <div>
        <h4 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">{{ __('app.status') }}</h4>
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
        <h5 class="font-medium text-blue-900 dark:text-blue-100 mb-2">{{ __('app.instructions') }}</h5>
